        ...
        <div className="header-top">
          <div className="container">
            ...
            <div className="header-right">
              ...
              <a href="contact-us.html" className="contact d-lg-show"><i className="d-icon-map" />Contact</a>
              <a href="#" className="help d-lg-show"><i className="d-icon-info" /> Need Help</a>
              <a className="login-link" href="ajax/login.html" data-toggle="login-modal"><i className="d-icon-user" />Sign in</a>
          ...
          <div className="container">
            ...
            <div className="header-right">
              ...
              <div className="dropdown wishlist wishlist-dropdown off-canvas">
                <a href="wishlist.html" className="wishlist-toggle" title="wishlist">
                ...
                <div className="dropdown-box scrollable">
                  ...
                  <div className="products scrollable">
                    <div className="product product-wishlist">
                      ...
                      <div className="product-detail">
                        <a href="product.html" className="product-name">Girl's Dark Bag</a>
                    ...
                    <div className="product product-wishlist">
                      ...
                      <div className="product-detail">
                        <a href="product.html" className="product-name">Women's Fashional Comforter
                        </a>
                        <div className="price-box">
                          <span className="product-price">$84.00</span>
                        </div>
                    ...
                    <div className="product product-wishlist">
                      ...
                      <div className="product-detail">
                        <a href="product.html" className="product-name">Wide Knickerbockers</a>
                        <div className="price-box">
                          <span className="product-price">$84.00</span>
                        </div>
                      </div>
                  ...
                  <a href="wishlist.html" className="btn btn-dark wishlist-btn mt-4"><span>Go To
                      Wishlist</span></a>
                  {/* End of Products  */}
                </div>
                {/* End Dropdown Box */}
                ...
                <div className="dropdown-box">
                  <div className="products scrollable">
                    <div className="product product-cart">
                      ...
                      <div className="product-detail">
                        <a href="product.html" className="product-name">Riode White Trends</a>
                        <div className="price-box">
                    ...
                    <div className="product product-cart">
                      ...
                      <div className="product-detail">
                        <a href="product.html" className="product-name">Dark Blue Women’s
                          Leomora Hat</a>
                        <div className="price-box">
                          <span className="product-quantity">1</span>
                  ...
                  <div className="cart-action">
                    <a href="cart.html" className="btn btn-dark btn-link">View Cart</a>
                    <a href="checkout.html" className="btn btn-dark"><span>Go To Checkout</span></a>
                  </div>
                  {/* End of Cart Action */}
                </div>
                {/* End Dropdown Box */}
