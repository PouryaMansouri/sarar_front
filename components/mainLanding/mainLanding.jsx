                ...
                <div className="mb-4 col-lg-3 col-md-4 col-6">
                  ...
                  >
                    ...
                    <div className="product-details">
                      ...
                      <div className="product-price">
                        <span className="price">$93.24</span>
                      </div>
                      <div className="ratings-container">
                        <div className="ratings-full">
                          <span className="ratings" style={{ width: "40%" }} />
                ...
                <div className="mb-4 col-lg-3 col-md-4 col-6">
                  ...
                  >
                    ...
                    <div className="product-details">
                      ...
                      <div className="product-price">
                        <span className="price">$61.35</span>
                      </div>
                      <div className="ratings-container">
                        <div className="ratings-full">
                          <span className="ratings" style={{ width: "80%" }} />
                ...
                <div className="mb-4 col-lg-3 col-md-4 col-6">
                  ...
                  >
                    ...
                    <div className="product-details">
                      ...
                      <h3 className="product-name">
                        <a href="demo2-product.html">
                          Converse Blue Trainaing Shoes
                        </a>
                      </h3>
                      <div className="product-price">
                        <ins className="new-price">$347.23</ins>
                        <del className="old-price">$386.23</del>
                      </div>
                      <div className="ratings-container">
                        <div className="ratings-full">
                          <span className="ratings" style={{ width: "40%" }} />
